...
def get_pkg_info(pkg_name: str='') -> str:
    if not pkg_name:
        return '不加参数超级坏！'
...
def search_repo_pkg(description: str='', limit: int=100):
    if not description:
        return '不加参数超级坏！'
...
def search_repo_maintainer(name: str='', limit: int=100):
    if not name:
        return '不加参数超级坏！'
...
def get_pkg_info_aur(pkg_name: str='') -> str:
    if not pkg_name:
        return '不加参数超级坏！'
...
def search_aur_pkg(keyword: str='') -> str:
...
def search_aur_maintainer(name: str='') -> str:
    if not name:
        return '不加参数超级坏！'
...
if __name__ == '__main__':
    print(search_aur_maintainer('fansuregrin'))